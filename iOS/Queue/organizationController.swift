...
//  Queue
//
//  Created by Adam Levy on 7/23/15.
...
class organizationController: UIViewController, UITextFieldDelegate {
    
    var server = "http://localhost:8000";
    var orgName : String = ""
    @IBOutlet var tableView: UITableView!
    //@IBOutlet weak var orgLabel : UILabel!
    @IBOutlet weak var orgTitle : UINavigationBar!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.orgTitle.topItem?.title = self.orgName
        getUsersInQueue()
        //sleep(10)
